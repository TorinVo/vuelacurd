<template>
    <div class="conditional-rendering">
        ...
        <div class="block-1" v-show="currentBlock == 1">
            This is block 1 v-show
        </div>
        <div class="block-2" v-show="currentBlock == 2">
            This is block 2 v-show
        </div>
        <div class="block-3" v-show="currentBlock == 3">
            This is block 3 v-show
        </div>
    </div>
</template>
